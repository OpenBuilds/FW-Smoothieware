...
#define ohw_logo_antipixel_height 16
static const uint8_t ohw_logo_antipixel_bits[] = {
  
};
...
void Panel::idle_processing()
{
    if (this->start_up) {
        ...
        this->lcd->clear();
        this->lcd->setCursor(6, 0); this->lcd->printf("OpenBuilds");
        this->lcd->setCursor(0, 6); this->lcd->printf("Smoothie");
        this->lcd->setCursor(2, 4); this->lcd->printf("www.openbuilds.com");
        this->lcd->setCursor(9, 6); this->lcd->printf("%s", build.substr(0, 4).c_str());
        this->lcd->setCursor(13, 6); this->lcd->printf("%s", build.substr(5, 20).c_str());
        this->lcd->setCursor(5, 7); this->lcd->printf("%s", date.substr(0, 12).c_str());

        if (this->lcd->hasGraphics()) {
            this->lcd->bltGlyph(24, 10, ohw_logo_antipixel_width, ohw_logo_antipixel_height, ohw_logo_antipixel_bits);
        }
